...
from engine import train_one_epoch, evaluate, do_TTT
import models
import my_models
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default="/data/yiming.hao/code/TALL4Deepfake_raw_2_new/output/TALL_JPL/onlyFace2face/TTT/FS",
    ...
    parser.add_argument('--initial_checkpoint', type=str, default='/data/yiming.hao/code/TALL4Deepfake_raw_2_new/output/TALL_JPL/onlyFace2Face/checkpoint50.pth', help='path to the pretrained model')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = do_TTT(
            model, criterion, data_loader_val,args.num_clips,
