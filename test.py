...
def get_args_parser():
    ...
    parser.add_argument('--dataset', default='FF++', choices=list(DATASET_CONFIG.keys()), help='path to dataset file list')
    ...
    # Model parameters
    # #  TALL_SWIN    mamba_vision_B     dinov3_vitb16
    parser.add_argument('--model', default='TALL_SWIN', type=str, metavar='MODEL', #TALL_SWIN  mamba_vision_B
...
#    parser.add_argument('--input-size', default=224, type=int, help='images input size')
    ...
    parser.add_argument('--output_dir', default="./output/FF++",
    ...
    # 测试时候需要填写在此位置需要填写一个地址

    parser.add_argument('--initial_checkpoint', type=str, default='/data/yiming.hao/code/TALL-SWIN/TALL4Deepfake/output/FF23++/raw/model_best.pth', help='path to the pretrained model')
    #  /data/yiming.hao/code/TALL4Deepfake_raw/output/FF40++/augment_ape/model_best.pth
    # /data/yiming.hao/code/TALL-SWIN/TALL4Deepfake/output/FF23++/raw/model_best.pth
...
# create data loaders w/ augmentation pipeiine
    ...
    if args.initial_checkpoint:
            ...
            # model.load_state_dict(checkpoint['state_dict'], strict=False)  # strict=False 忽略不匹配层（如分类头）
